...
def plot_lig_dihedral(
    ...
    """
    Plot ligand dihedral angle analysis from MD simulations.
    ...
    if fig_type == "Line":
        fig.subplots_adjust(
            top=0.95, bottom=0.06, left=0.10, right=0.97, wspace=0.25, hspace=0.15
        )
        ...
        fig.subplots_adjust(
            top=0.98, bottom=0.08, left=0.09, right=0.98, wspace=0.25, hspace=0.15
        )
        fig.text(0.5, 0.02, "Angle (\N{DEGREE SIGN})", va="center", ha="center")
    ...
    for i, inhibitor in enumerate(inhibitor_list):
        ...
        for j in [1, 2]:
            ...
            for k in ["A", "B"]:
                dat_file = f"{inhibitor}_dih{k}.dat"
    ...
    fig.text(0.089, 0.965, "(a)", va="center", ha="left")
    fig.text(0.407, 0.965, "(b)", va="center", ha="left")
    fig.text(0.725, 0.965, "(c)", va="center", ha="left")
    fig.text(0.089, 0.483, "(d)", va="center", ha="left")
    fig.text(0.407, 0.483, "(e)", va="center", ha="left")
    fig.text(0.725, 0.483, "(f)", va="center", ha="left")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Plot ligand dihedral angle analysis from MD simulations."
    )
    ...
    plot_lig_dihedral(args.md_path, system_type=args.system, fig_type=args.type)
